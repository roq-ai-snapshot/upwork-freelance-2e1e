...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('agency_owner', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'agency_owner',
          header: 'Agency Owner',
          accessorKey: 'agency_owner',
          cell: ({ row: { original: record } }: any) => record?._count?.agency_owner,
        }
      : null,
